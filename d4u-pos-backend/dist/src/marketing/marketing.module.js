...
exports.MarketingModule = MarketingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [marketing_service_1.MarketingService, social_service_1.SocialService],
        controllers: [marketing_controller_1.MarketingController, social_controller_1.SocialController]
    })
], MarketingModule);
